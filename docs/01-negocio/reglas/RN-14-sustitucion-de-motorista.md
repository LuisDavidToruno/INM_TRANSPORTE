...
2. Si el recurso entrante no pasa alguna comprobación, la sustitución se **bloquea** con la misma dureza que la asignación inicial. La urgencia no habilita: [NRM-06](../normativa/NRM-06-transito-y-licencias.md) no admite excepción.
...
- **Sustitución que rompe la segregación de funciones** — el motorista entrante es quien autorizó la orden. Bloqueo por [RN-01](RN-01-segregacion-de-funciones.md): conducir no es función de control, pero autorizar y luego ejecutar la misión que uno autorizó sí concentra control y ejecución en la misma persona. `[C]` confirmar el criterio con Auditoría Interna; hasta entonces, advertencia registrada, no bloqueo.
...
- Reglas relacionadas: [RN-09](RN-09-matriz-licencia-vehiculo.md) a [RN-13](RN-13-sin-doble-asignacion.md), [RN-22](RN-22-custodia-del-vehiculo.md), [RN-31](RN-31-odometro-de-retorno.md)
