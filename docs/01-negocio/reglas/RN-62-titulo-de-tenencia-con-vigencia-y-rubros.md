...
- **Estado terminal `RETIRADO_DE_FLOTA` inexistente.** La [máquina de estados](../../03-arquitectura/estados/orden-de-mision.md) es la autoridad y hoy no tiene ese estado; se reportó desde [CE-15](../../02-requisitos/casos-especiales/CE-15-vehiculo-en-comodato-o-alquilado.md) como ampliación necesaria, alcanzable desde `NO_DISPONIBLE`, con causa tipificada y acta de devolución obligatoria. **Esta regla no lo crea**: describe el comportamiento que debe tener cuando exista. **Nota de hallazgo abierta.**
