...
| 102 | **Por qué canal se avisa a quien tiene una tarea escalada** — correo institucional, SMS, o sólo la bandeja | §5.3.B.3 pide notificar además de encolar. **La bandeja ya opera y es el sistema de registro**; el aviso falta, y `NotificadoUtc` va nulo declarando que no se avisó. En delegaciones sin conectividad el correo y el SMS no sirven, así que **«sólo la bandeja» es una respuesta legítima** y no un rodeo. Lo mismo que esperan `RN-60` punto 3 y `RN-63` punto 4 | §5.3.B.3, `RN-60`, `RN-63` |
