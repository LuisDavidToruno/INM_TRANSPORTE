...
| 100 | **Régimen de tenencia del vehículo** — propio, comodato, alquilado — con vigencia y rubros | `RN-62` lo pide y no existe como campo. Sin él, la verificación de `HB3-17` —que el descargo sea de bienes propios y el retiro de ajenos— **siempre advierte en vez de juzgar**, y un vehículo en comodato se puede seguir declarando «dado de baja del registro de bienes del Estado»: el asiento falso que la corrección existe para impedir | `RN-62`, §10.2 |
